...
public class MainMenuGUI extends Application {
    ...
    public MainMenuGUI(Stage primaryStage) {
    ...
    public void start(Stage primaryStage) {
        ...
        dashboardLayout.setStyle("-fx-background-color: #f0f0f0; -fx-padding: 20px;");
        Text welcomeText = new Text("Welcome to the NBA Management System");
        welcomeText.setFont(new Font("Arial", 24));
        Button playerButton = new Button("Player Menu");
        Button teamButton = new Button("Team Menu");
        Button managerButton = new Button("Manager Menu");
        Button advancedButton = new Button("Advanced Menu");
        ...
        dashboardLayout.getChildren().addAll(welcomeText, playerButton, teamButton, managerButton, advancedButton);

        Scene scene = new Scene(dashboardLayout, 800, 600);
        primaryStage.setTitle("Main Menu - NBA Management System");
        primaryStage.setScene(scene);
        primaryStage.show();
    }

    private boolean showLoginPage(Stage stage) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/nba/menus/login.fxml"));
            ...
            stage.show();
            return loginController.isLoginSuccessful();
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    private void showMainMenu(Stage stage) {
        ...
        playerButton.setOnAction(e -> openPlayerMenu(stage));
        teamButton.setOnAction(e -> openTeamMenu(stage));
        managerButton.setOnAction(e -> openManagerMenu(stage));
        advancedButton.setOnAction(e -> openAdvancedMenu(stage));
        ...
        stage.setTitle("NBA Management System - Main Menu");
